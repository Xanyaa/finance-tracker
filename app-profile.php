                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-two">
                                    <header>
                                        <div class="avatar">
                                            <img src="images\avatar\new-avatar.png" alt="Person avatar" />
                                        </div>
                                    </header>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="newUsername" value="<?php echo $username; ?>" class="form-control form-control-line">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">Email</label>
                                                <div class="col-md-12">
                                                    <input type="email" value="<?php echo $email; ?>" class="form-control form-control-line" name="newEmail" id="example-email">
                                                </div>
                                            </div>
                                            <!-- <div class="form-group">
                                <label class="col-md-12">Bio</label>
                                <div class="col-md-12">
                                    <input type="password" name="newPassword" class="form-control form-control-line" required>
                                </div>
                            </div> -->
                                            <div class="form-group">
                                                <div class="col-sm-12">
